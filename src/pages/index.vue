    ...
    >
        ...
        >
            <template #header>
                <y-switch-accounts
                    :services="services"
                    :account-id="$route.query.account || 'XzeiBiHt'"
                />
            </template>
            <y-file-input
                v-model="file"
        ...
        this.services = [
            {
                ...
                type: 'marketer',
                service: 'yektanet',
                app_title: 'www.dahgaal.com',
                url: 'https://accounts.yektanet.com/login?account=abcdefg',
            },
            {
                account: 'XzeiBiHt',
                type: 'marketer',
                service: 'yektanet',
                app_title: 'www.dah.com',
                url: 'https://accounts.yektanet.com/login?account=abcdefg',
            },
            {
                account: 'OpxNQrvA',
            ...
            },
            {
                ...
                type: 'pub',
                service: 'triboon',
                app_url: 'asdfasdf.com',
                url: 'https://accounts.yektanet.com/login/?account=9lOsThJs',
                app_title: 'asdfasdf.com',
            },
            {
                account: 'VFSUDmf7',
                type: 'adv',
                service: 'yektanet',
                app_title: 'digffffihhhhhh.com',
                url: 'https://accounts.yektanet.com/login?account=abcdefg',
            },
            {
                account: 'wCusfBvM',
                type: 'adv',
                service: 'yektanet',
                app_url: 'ewadsfds.com',
                url: 'https://accounts.yektanet.com/login/?account=wCusfBvM',
                app_title: 'ewadsfds.com',
            },
            {
                account: 'lPE5lFmJ',
                type: 'pub',
