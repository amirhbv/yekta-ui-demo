    ...
    >
      ...
      <div class="d-flex align-items-center">
        <y-input
          ...
          number
        >
          <template #help-title> توضیحات <strong>فیلد</strong> </template>
      ...
      <y-toggle v-model="toggle" :width="100" field-label="Toggle with text">
        <template #checked>
          بله
        </template>
        <template #unchecked>
      ...
      <y-alert variant="success" dismissible @dismissed="log('close')">
        ...
        spacing within an alert works with this kind of content. Aww yeah, you
      ...
      >
        ...
        نمایش‌دهندگان محدود کنید. <br />همچنین با افزودن یک نمایش‌دهنده به
        <b>لیست سیاه</b>، هیچ کدام از محتواهای تبلیغاتی شما در آن نمایش داده
        نخواهد شد. شما می‌توانید با تعریف <b>گروه نمایش‌دهنده</b>، نمایش تبلیغات
        خود را به گروهی خاص از
      </y-form-description>
